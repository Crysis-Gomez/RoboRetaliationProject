...
echo.
Start adl -screensize %SCREEN_SIZE% "%APP_XML%" "%APP_DIR%" 
Start adl -screensize %SCREEN_SIZE% "%APP_XML2%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML3%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML4%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML5%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML6%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML7%" "%APP_DIR%"
::Start adl -screensize %SCREEN_SIZE% "%APP_XML8%" "%APP_DIR%"
