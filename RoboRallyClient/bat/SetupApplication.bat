...
:: Android packaging
set AND_CERT_NAME="RoboRetaliation"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RoboRetaliation.p12
...
set IOS_PROVISION=cert\RoboRetaliation.mobileprovision
...
set APP_ID=air.RoboRetaliation

:: Output packages
set DIST_PATH=dist
set DIST_NAME=RoboRetaliation
